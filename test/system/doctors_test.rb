...
class DoctorsTest < ApplicationSystemTestCase
  ...
  test "creating a Doctor" do
    ...
    fill_in "Consultorio", with: @doctor.consultorio
    fill_in "Especialidad", with: @doctor.especialidad
    fill_in "No cedula", with: @doctor.no_cedula
    fill_in "Nombre", with: @doctor.nombre

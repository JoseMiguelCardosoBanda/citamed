class CitaController < ApplicationController
  ...
  def create
    @cita = Cita.new(citum_params)

    respond_to do |format|
      if @cita.save
        format.html { redirect_to citum_url(@cita), notice: "Cita was successfully created." }
  ...
  def update
    respond_to do |format|
      if @cita.update(citum_params)
        format.html { redirect_to citum_url(@cita), notice: "Cita was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to cita_url, notice: "Cita was successfully destroyed." }

class PacientesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @paciente.save
        format.html { redirect_to paciente_url(@paciente), notice: "Paciente creado." }
  ...
  def update
    respond_to do |format|
      if @paciente.update(paciente_params)
        format.html { redirect_to paciente_url(@paciente), notice: "Paciente actualizado." }
  ...
  private
    ...
    def paciente_params
      params.require(:paciente).permit(:nombre, :edad, :num_seguro, :direccion, :telefono, :contacto_dos, :fecha_nacimiento, :curp)
    end
end
